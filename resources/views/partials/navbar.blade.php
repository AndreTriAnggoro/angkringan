  ...
  <div class="container flex-column">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav flex-column">
        <li class="nav-item">
        <a class="nav-link {{ Request::is('admin') ? 'active' : '' }}" href="/admin"> <i class="bi bi-border-all"></i>Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('menu') ? 'active' : '' }}" href="/menu"><i class="bi bi-back"></i>Menu</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('about') ? 'active' : '' }}" href="/about"><i class="bi bi-cart-check-fill"></i>Order</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('transaksi') ? 'active' : '' }}" href="/transaksi"><i class="bi bi-clipboard2-minus-fill"></i>Transaksi</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('laporan') ? 'active' : '' }}" href="/laporan"><i class="bi bi-journals"></i>Laporan</a>
        </li>
        <ul class="navbar-nav flex-column">
          @auth
            <li class="nav-item">
